...
result = agent.run("bring me 5 trump related news stories from march 2025. summarize them briefly and create a headline for each one. use the tools I gave you to do this.")
print(result)